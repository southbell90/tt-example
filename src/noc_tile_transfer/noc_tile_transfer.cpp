...
int main() {
    ...
    // The synchronization and data mechanisms inside the kernels operate using physical core coordinates
    // rather than logical ones. We obtain the physical coordinates using the worker_core_from_logical_cor function.
    ...
    KernelHandle core0_reader_kernel_id = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/noc_tile_transfer/kernels/reader0.cpp",
        core0,
        tt::tt_metal::ReaderDataMovementConfig{reader_compile_time_args});
    KernelHandle core0_writer_kernel_id = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/noc_tile_transfer/kernels/writer0.cpp",
        core0,
    ...
    KernelHandle core1_reader_kernel_id = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/noc_tile_transfer/kernels/reader1.cpp",
        core1,
    ...
    KernelHandle core1_writer_kernel_id = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/noc_tile_transfer/kernels/writer1.cpp",
        core1,
