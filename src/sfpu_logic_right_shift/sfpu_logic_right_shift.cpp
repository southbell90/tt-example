...
int main() {
    ...
    KernelHandle reader_id = CreateKernel(
        program,
        "/home/southbell/tt-example/src/sfpu_logic_right_shift/kernels/reader.cpp",
        core,
        DataMovementConfig{
    ...
    KernelHandle writer_id = CreateKernel(
        program,
        "/home/southbell/tt-example/src/sfpu_logic_right_shift/kernels/writer.cpp",
        core,
        DataMovementConfig{
    ...
    KernelHandle compute_id = CreateKernel(
        program,
        "/home/southbell/tt-example/src/sfpu_logic_right_shift/kernels/compute.cpp",
        core,
        ComputeConfig{
