void kernel_main() {
    std::uint32_t src0_dram = get_arg_val<uint32_t>(0);
    std::uint32_t src1_dram = get_arg_val<uint32_t>(1);
    std::uint32_t dst_dram = get_arg_val<uint32_t>(2);
    std::uint32_t src0_l1 = get_arg_val<uint32_t>(3);
    std::uint32_t src1_l1 = get_arg_val<uint32_t>(4);
    std::uint32_t dst_l1 = get_arg_val<uint32_t>(5);
