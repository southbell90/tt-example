...
int main(int /*argc*/, char** /*argv*/) {
    ...
    auto reader = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/custom_sfpi_smoothstep/kernels/read_tiles.cpp",
        core,
    ...
    auto writer = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/custom_sfpi_smoothstep/kernels/write_tile.cpp",
        core,
    ...
    auto compute = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/custom_sfpi_smoothstep/kernels/tiles_smoothstep.cpp",
        core,
        ComputeConfig{
    ...
    if (pass) {
        fmt::print("Test Passed!! -- smoothstep\n");
    } else {
