...
int main() {
    ...
    auto reader = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/custom_sfpi_add/kernels/read_tiles.cpp",
        core,
    ...
    auto writer = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/custom_sfpi_add/kernels/write_tile.cpp",
        core,
    ...
    auto compute = CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "/home/southbell/tt-example/src/custom_sfpi_add/kernels/tiles_add.cpp",
        core,
        ComputeConfig{
    ...
    if (pass) {
        fmt::print("Test Passed!!! - custom_sfpi_add\n");
    } else {
